...
function removeUpperDis() {
  ...
  upperIcon.classList.add("text-dark");
...
function removeLowerDis() {
  ...
  lowerIcon.classList.add("text-dark");
...
function removeNumberDis() {
  ...
  numberIcon.classList.add("text-dark");
...
function removeSymbolDis() {
  ...
  symbolIcon.classList.add("text-dark");
...
function removeLenDis() {
  ...
  lengthIcon.classList.add("text-dark");
...
function matchDisplaySetting(element, index) {
  if (index === 7) {
    ...
    lengthIcon.classList.remove("text-dark");
  ...
  if ((element >= "A") & (element <= "Z")) {
    ...
    upperIcon.classList.remove("text-dark");
  ...
  if ((element >= "a") & (element <= "z")) {
    ...
    lowerIcon.classList.remove("text-dark");
  ...
  if ((element >= "0") & (element <= "9")) {
    ...
    numberIcon.classList.remove("text-dark");
  ...
  if (element === "!" || element === "@" || element <= "#" || element === "$") {
    ...
    symbolIcon.classList.remove("text-dark");
